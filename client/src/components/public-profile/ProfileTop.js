...
const ProfileTop = ({ profile: { profession, user: {name, picture}, company, location, bio, skills, education, experience } }) => {
    return (
        <Fragment>
                    ...
                    <div className="col-sm-12">
                        <div className="bg-picture text-center mt-2">
                            ...
                            <div className="profile-info-name">
                                <img src={ picture ? picture : "/noimg.png" } className="pic-respo" alt="Responsive image" />
